...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hboard-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15601&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hboard-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hboard` can be installed with:

```
conda install hboard
```

It is possible to list all of the versions of `hboard` available on your platform with:
